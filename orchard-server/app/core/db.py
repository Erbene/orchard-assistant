...
_STARTUP_DDL: tuple[str, ...] = (
    ...
    # zones moved to Rachio: drop the FK, tree.zone_id -> text. Local ``zone``
    # is now a label overlay (do not DROP — that would wipe grower labels).
    ...
    "CREATE INDEX IF NOT EXISTS idx_executed_task_log_tree_executed ON executed_task_log (tree_id, executed_at DESC)",
    "CREATE INDEX IF NOT EXISTS idx_executed_task_log_executed ON executed_task_log (executed_at DESC)",
)
